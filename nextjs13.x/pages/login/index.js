...
export default function Signin({ token, providers, loginError }) { 
  ...
  // useEffect(() => {
  //   if(token !== null) router.push('/auth/page-one')  
  // }, []);
...
export async function getServerSideProps(context) {
  ...
  try {    
    ...
    return { props: { token: token,  providers: await getProviders(), loginError: error } };
  } catch (e) {
